...
from .bert_utils import bert_pair_converter


# pair_feature_converter = {
#     "bert":bert_pair_converter, 
# }
...
class pair_dataset(Dataset):
    def __init__(
        ...
        logger.info('[%s] success load pairs = %d'%(mode, len(examples)))
